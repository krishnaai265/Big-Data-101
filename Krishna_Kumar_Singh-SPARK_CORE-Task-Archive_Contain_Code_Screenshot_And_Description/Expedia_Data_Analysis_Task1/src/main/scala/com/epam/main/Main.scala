...
object Main {
  def main(args: Array[String]) {        
        ...
        println(sparkSession.read.csv("C:\\Users\\Krishna_Singh1\\eclipse-workspace\\ExcelToAvroConverter\\ExcelToAvroConverter\\src\\main\\resources\\train-100.csv").first)
